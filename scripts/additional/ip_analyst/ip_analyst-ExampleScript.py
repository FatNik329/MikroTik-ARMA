...
DEFAULT_CONFIG = {
    ...
    'asn_include': 'none',  # Пример: определённые ASN ['AS8075', 'AS15169', 'AS32934'] для включения в итоговый результат. Без фильтрации: none
    'asn_exclude': 'none',  # Пример: определённые ASN ['AS8075', 'AS15169', 'AS32934'] для исключения из итогового результата. Без фильтрации: none
    ...
    'prefix_size': 24, # Указать размер префикса для агрегации. Поддерживаются от /16 до /32, по умолчанию /24.
    'exclude_non_aggregated_ips': 'false', # true/false - исключает одиночные IP не прошедших агрегацию в префикс
}
